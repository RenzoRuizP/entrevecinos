...
INSERT INTO `menu` (`codigo_menu`, `nombre`, `icono`, `orden`, `estado`) VALUES
	...
	(7, 'Billetera', 'bi-wallet2', 4, 1),
	(4, 'Comunidad', 'bi-people-fill', 5, 1),
	(5, 'Soporte', 'bi-headset', 6, 1),
	(6, 'Administración', 'bi-sliders', 7, 1);
...
(8,7,'Resumen','/billetera','bi-grid',1,1),
...
(28,2,9,0,1,0,0),(29,2,16,0,1,0,0),(41,2,20,1,1,1,0),(42,2,21,1,1,1,0),
