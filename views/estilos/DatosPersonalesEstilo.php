...
@media (min-width: 1200px){
  #modalAgregarPublicacion .modal-dialog{ max-width: 1140px; }
}
...
/* =========================================================
   ✅ FIX SCROLL DEL MODAL + PREVIEW RESPONSIVA EN MÓVIL
   (no altera el look de escritorio)
========================================================= */
...
/* Altura segura en móviles cuando es fullscreen */
@supports (height:100svh){
  #modalAgregarPublicacion.modal-fullscreen-md-down .modal-content{ height:100svh; }
}
#modalAgregarPublicacion.modal-fullscreen-md-down .modal-content{
  height:calc(var(--ev-vh, 1vh) * 100);
}
/* En móvil, el preview no ocupa toda la pantalla */
