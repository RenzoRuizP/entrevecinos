...
<style>
/* ============================================================
   EV 2026-08-06 — Cierre y acciones estándar del detalle
============================================================ */
#mp_modal_detalle .ev-mp-modal-header .btn-close.ev-modal-close-icon{
...
#mp_modal_detalle .ev-mp-modal-header .btn-close.ev-modal-close-icon::before,
#mp_modal_detalle .ev-mp-modal-header .btn-close.ev-modal-close-icon::after{
  display:none !important;
  content:none !important;
}
#mp_modal_detalle .ev-mp-modal-header .btn-close.ev-modal-close-icon:hover,
#mp_modal_detalle .ev-mp-modal-header .btn-close.ev-modal-close-icon:focus-visible{
...
#mp_modal_detalle .ev-mp-modal-footer .btn-ev-neutral,
#mp_modal_detalle .ev-mp-modal-footer .btn-ev-primary{
  display:inline-flex !important;
  align-items:center !important;
  justify-content:center !important;
  gap:8px !important;
}
#mp_modal_detalle .ev-mp-modal-footer .btn-ev-neutral i,
#mp_modal_detalle .ev-mp-modal-footer .btn-ev-primary i{
  margin:0 !important;
  line-height:1 !important;
}
</style>
...
<style>
/* EV 2026-08-09 — foco de formularios y acciones de modal consistentes. */
#mp_modal_solicitud .form-control:focus,
#mp_modal_solicitud .form-select:focus,
#mp_modal_solicitud textarea.form-control:focus,
#mp_modal_solicitud input.form-control:focus{
  border-color:#16A34A !important;
  box-shadow:0 0 0 4px rgba(22,163,74,.13) !important;
  outline:0 !important;
}
#mp_modal_solicitud .form-control:focus-visible,
#mp_modal_solicitud .form-select:focus-visible{outline:0 !important;}
#mp_modal_detalle .ev-mp-modal-footer .btn-ev-neutral,
#mp_modal_detalle .ev-mp-modal-footer .btn-ev-primary,
#mp_modal_solicitud .ev-mp-modal-footer .btn-ev-neutral,
#mp_modal_solicitud .ev-mp-modal-footer .btn-ev-primary{
  display:inline-flex !important;align-items:center !important;justify-content:center !important;gap:8px !important;
}
#mp_modal_detalle .ev-mp-modal-footer i,
#mp_modal_solicitud .ev-mp-modal-footer i{margin:0 !important;line-height:1 !important;flex:0 0 auto !important;}
@media (max-width:575.98px){
  #mp_modal_detalle .ev-mp-modal-footer .btn-ev-neutral,
  #mp_modal_detalle .ev-mp-modal-footer .btn-ev-primary,
  #mp_modal_solicitud .ev-mp-modal-footer .btn-ev-neutral,
  #mp_modal_solicitud .ev-mp-modal-footer .btn-ev-primary{width:100%;}
}
</style>
...
<style>
/* ============================================================
   EV 2026-08-09 — Cierre definitivo del modal Detalle de publicación
   Corrige la colisión de reglas históricas del btn-close y replica
   el cierre visible del modal Solicitar cotización.
============================================================ */
#mp_modal_detalle .ev-mp-modal-header .btn-close.ev-modal-close-icon{
  appearance:none !important;
  -webkit-appearance:none !important;
...
#mp_modal_detalle .ev-mp-modal-header .btn-close.ev-modal-close-icon:active{
  background-color:rgba(15,89,47,.42) !important;
}
@media(max-width:575.98px){
  #mp_modal_detalle .ev-mp-modal-header .btn-close.ev-modal-close-icon{
    width:36px !important;
