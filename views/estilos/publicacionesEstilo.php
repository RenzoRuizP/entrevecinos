...
/* Ajustes anti-desborde en el modal de agregar */
...
.ev-preview-thumb.active{
  border-color:#0F592F;
  box-shadow:0 0 0 .15rem rgba(15,89,47,0.18);
}
...
@media (max-width: 576px){
  ...
  /* Ocultar previsualización y columna derecha solo en móvil */
  #previewMount,
  #evPreviewWrapper,
  #evMetaCard{
...
/* ==========================================================
   ✅ Footer siempre visible dentro del modal
   - Header y footer no se mueven
   - Solo .modal-body hace scroll
...
/* Opcional: títulos de sección dentro del modal */
.ev-section-title{
  font-size: .9rem;
  font-weight: 700;
...
/* Opcional: asterisco obligatorio */
.ev-required::after{
  content:' *';
  color:#dc2626;
  font-weight:700;
...
/* ============================================
   📸 Nuevo Uploader — UX/UI profesional
============================================ */
.ev-dropzone{
