      ...
      <li class="nav-item dropdown user-menu">
        ...
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
          ...
          <li class="user-footer">
            ...
            <!--<a href="../controllers/logoutController.php" class="btn btn-default btn-flat float-end">Cerrar sesion</a>-->
            <a href="#" id="btnCerrarSesion" class="btn btn-default btn-flat float-end">Cerrar sesión</a>
