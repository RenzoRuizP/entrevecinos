...
<div class="main-container flex-grow-1 d-flex flex-column" style="min-height: 100vh;">

  <!-- 🔹 Barra superior -->
  <nav class="app-header navbar navbar-expand-lg navbar-dark shadow-sm px-3" style="background-color:#0F592F; position: relative; z-index: 1030;">
