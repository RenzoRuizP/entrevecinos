...
<div class="ev-ap-lightbox" id="evApLightbox" hidden aria-hidden="true">
  ...
  <section
    ...
    role="dialog"
    aria-modal="true"
    aria-labelledby="evApLightboxTitle"
  >
    <header class="ev-ap-lightbox-head">
      <div>
        <span class="ev-ap-lightbox-kicker">Vista ampliada</span>
        <h6 id="evApLightboxTitle">Imagen de la publicación</h6>
      </div>

      <button
        type="button"
        class="ev-ap-lightbox-close"
        id="evApLightboxClose"
    ...
    <div class="ev-ap-lightbox-stage">
      <button
        type="button"
        class="ev-ap-lightbox-nav ev-ap-lightbox-prev"
        id="evApLightboxPrev"
      ...
      <img id="evApLightboxImage" src="" alt="Imagen ampliada de la publicación">

      <button
        type="button"
        class="ev-ap-lightbox-nav ev-ap-lightbox-next"
        id="evApLightboxNext"
    ...
    <footer class="ev-ap-lightbox-foot">
      <span id="evApLightboxCounter">1 de 1</span>
      <small>Usa las flechas del teclado o desliza entre las imágenes disponibles.</small>
    </footer>
  </section>
</div>
