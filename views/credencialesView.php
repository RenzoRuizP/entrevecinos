...
<div class="ev-credenciales-wrapper fade-in">
  ...
  <!-- MENSAJE INFORMATIVO -->
  <div class="alert alert-info ev-credenciales-alert d-flex align-items-start gap-2 mb-3">
  ...
  <div class="card ev-credenciales-card">
    ...
    <div class="card-body">
      ...
      <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-2 mb-2">
        <div>
          <div class="fw-semibold ev-credenciales-user-name">
            <?= $nombreUsuario ?>
          </div>
          <div class="ev-credenciales-user-email">
      ...
      <form id="formCambiarContrasena" autocomplete="off">
        <div class="row g-3">
          ...
          <div class="col-12 col-md-4">
            <label class="ev-credenciales-form-label mb-1" for="password_actual">
              Contraseña actual
            </label>
          ...
          <!-- Nueva contraseña -->
          <div class="col-12 col-md-4">
            <label class="ev-credenciales-form-label mb-1" for="password_nueva">
              Nueva contraseña
            </label>
          ...
          <div class="col-12 col-md-4">
            <label class="ev-credenciales-form-label mb-1" for="password_confirmar">
              Confirmar nueva contraseña
            </label>
            <div class="position-relative">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-end gap-2 gap-md-3 mt-4">
          <button type="button" class="btn btn-ev-neutral">
            Cancelar
          </button>
          <button type="button" class="btn btn-ev-primary">
            Guardar contraseña
          </button>
        </div>
      </form>
